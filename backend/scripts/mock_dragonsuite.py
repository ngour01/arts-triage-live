"""Local mock DragonSuite API + static log tree for testing log_crawler."""
...
def get_state_dump(cycle_id: str, feature: str, test_case: str):
    if "test_case_A" in test_case:
        return {
            "result": "FAIL",
            "result_type": "product_error",
            "error_class": "KernelPanic",
            "error_message": "Host crashed unexpectedly.",
        }
    return {
        "result": "FAIL",
        "result_type": "infra_error",
        "error_class": "NetworkFault",
        "error_message": "FAILED TO GET IP from DHCP server.",
    }
